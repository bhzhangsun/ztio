...
**同一套协议，三端的分叉点几乎全在这里**：授权声明、接口枚举 API、后台策略。
协议本身见 [`../docs/protocol.md`](../docs/protocol.md)，选路见 [`../docs/path-selection.md`](../docs/path-selection.md)。
...
见 [`../docs/protocol.md`](../docs/protocol.md) 附录「诊断指标」。
